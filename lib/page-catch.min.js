...
/*!
	   ...
	   */
return u={},f=!1,h=function(e){var t,n,o,c,h,d,p,g,b,v,y,E,T,w,L,B,N,O,H,C,M,q,U,j,I,_,R,W,D,P,X,G,J,F,Y,$,K,V,z,Q,Z,ee,te;for(U=null!=(_=u[""])?_.document.querySelectorAll("[name]"):void 0,b=0,T=U.length;b<T;b++)if(q=U[b],"original-url"===q.getAttribute("name"))return J=m(u[""].header,u[""].doctype)+u[""].text+"</html>",void("function"==typeof r&&r(J));for(h=[],C=null!=(R=u[""])?R.document.querySelectorAll("link"):void 0,g=!1,p=0,v=0,w=C.length;v<w;v++)H=C[v],G=H.getAttribute("rel"),null!==G&&G.indexOf("icon")!==-1&&("icon"===G&&(g=!0),h.push(H));g||(ee=null!=(W=u[""])?W.url[0]:void 0,te=ee.split("/"),te=te.slice(0,3),ee=te.join("/")+"/favicon.ico",H=document.createElement("link"),H.setAttribute("rel","icon"),p=1,S(ee,H,function(t,r,o){var l;return null!=t?(p--,console.error("(src)Base 64 error:",t.stack)):(""===o?(p++,0!==h.length?l=h[0].getAttribute("href"):p--,e(z,n,p),S(l,r,function(t,r,o){return null!=t?(p--,console.error("(src)Base 64 error:",t.stack)):(r.setAttribute("href",o),u[""].document.head.appendChild(r),p--),e(z,n,p)})):(r.setAttribute("href",o),u[""].document.head.appendChild(r),p--),e(z,n,p))})),n=0,z=0;for(y in u){for(c=u[y],c.document.head=a(c.document.head),K=c.document.querySelectorAll("style"),E=0,L=K.length;E<L;E++)if($=K[E],0===$.innerHTML.length)for(F=s($),D=c.styleSheets,M=0,B=D.length;M<B;M++)if(t=D[M],t[1]===F){$.innerHTML=t[0];break}for(Z=c.document.querySelectorAll("*[style]"),j=0,N=Z.length;j<N;j++)V=Z[j],n++,x(V.getAttribute("style"),V,c.url[0],c,[],function(t,r,u,o){return n--,null!=t?console.error("Style attr error",t):r.setAttribute("style",o),e(z,n,p)});for(Q=c.document.querySelectorAll("img,link,source,style, object"),I=0,O=Q.length;I<O;I++)if(V=Q[I],z++,"LINK"!==V.nodeName)if("IMG"!==V.nodeName)if("OBJECT"!==V.nodeName)if("STYLE"!==V.nodeName)if("SOURCE"!==V.nodeName)z--;else{if(V.type.indexOf("video")>-1||V.type.indexOf("audio")>-1){z--;continue}if(V.hasAttribute("srcset")&&!V.hasAttribute("src")){Y=i(V.getAttribute("srcset"),c.url[0],c.url[1]),S(Y,V,function(t,r,u){return z--,null!=t?console.error("(src)Base 64 error:",t.stack):r.setAttribute("srcset",u),e(z,n,p)});continue}if(V.hasAttribute("src")&&!V.hasAttribute("srcset")){Y=i(V.getAttribute("src"),c.url[0],c.url[1]),S(Y,V,function(t,r,u){return z--,null!=t?console.error("(src)Base 64 error:",t.stack):r.setAttribute("src",u),e(z,n,p)});continue}if(V.hasAttribute("src")&&V.hasAttribute("srcset")){V.setAttribute("srcset",""),Y=i(V.getAttribute("src"),c.url[0],c.url[1]),S(Y,V,function(t,r,u){return z--,null!=t?console.error("(src)Base 64 error:",t.stack):r.setAttribute("src",u),e(z,n,p)});continue}z--}else x(V.innerHTML,V,c.url[0],c,[],function(t,r,u,o){return z--,null!=t?console.error("(style)inlineCSS error:",t.stack):r.innerHTML=o,e(z,n,p)});else{if(V.hasAttribute("data")){Y=i(V.getAttribute("data"),c.url[0],c.url[1]),S(Y,V,function(t,r,u){return z--,null!=t?console.error("(src)Base 64 error:",t.stack):r.setAttribute("srcset",u),e(z,n,p)});continue}z--}else{if(V.hasAttribute("srcset")&&!V.hasAttribute("src")){Y=i(V.getAttribute("srcset"),c.url[0],c.url[1]),S(Y,V,function(t,r,u){return z--,null!=t?console.error("(src)Base 64 error:",t.stack):r.setAttribute("srcset",u),e(z,n,p)});continue}if(V.hasAttribute("src")&&!V.hasAttribute("srcset")){Y=i(V.getAttribute("src"),c.url[0],c.url[1]),S(Y,V,function(t,r,u){return z--,null!=t?console.error("(src)Base 64 error:",t.stack):r.setAttribute("src",u),e(z,n,p)});continue}if(V.hasAttribute("src")&&V.hasAttribute("srcset")){V.setAttribute("srcset",""),Y=i(V.getAttribute("src"),c.url[0],c.url[1]),S(Y,V,function(t,r,u){return z--,null!=t?console.error("(src)Base 64 error:",t.stack):r.setAttribute("src",u),e(z,n,p)});continue}z--}else{if("stylesheet"===(P=V.getAttribute("rel"))||"prefetch stylesheet"===P){d=i(V.getAttribute("href"),c.url[0],c.url[1]),o=V.attributes,x(A(d),V,d,c,o,function(t,r,u,o,l){var i,s,c,a;if(z--,null!=t)console.error("style error",t);else{for(console.log("INLINECSSS_END",r),$=document.createElement("style"),$.innerHTML=o,c=0,s=l.length;c<s;c++)i=l[c],$.setAttribute(i.name,i.value);a=r.parentElement,a.insertBefore($,r),a.removeChild(r)}return e(z,n,p)});continue}if(X=V.getAttribute("rel"),k.call(l,X)>=0){V.parentElement.removeChild(V),z--;continue}d=i(V.getAttribute("href"),c.url[0],c.url[1]),S(d,V,function(t,r,u){return z--,null!=t?console.error("(href) xhrToBase64 error (href="+d+"):",t.stack):r.setAttribute("href",u),e(z,n,p)})}}return f=!0,e(z,n,p)},n=function(e,r){var o,l,i,s,a,f,h,d,p,g,v;for(s=e.document.getElementsByTagName("iframe"),p=[],f=0,d=s.length;f<d;f++){i=s[f],g=b(i,e.document),a=-1;for(h in e.framesIdx)g===h&&(a=e.framesIdx[h]);a!==-1&&(h=r+a,null!=u[h]?(n(u[h],h+":"),l=u[h].url,o=u[h].document,c(o,l[0]),"function"==typeof t&&t(o,l[0]),v=m(u[h].header,u[h].doctype)+o.documentElement.innerHTML+"</html>",p.push(i.setAttribute("srcdoc",v))):p.push(void 0))}return p},o=function(e,o,l){var i,s,a;if(console.log(e,o,l,f),0===e&&0===o&&0===l&&f===!0)return n(u[""],""),s=u[""].url,i=u[""].document,c(i,s[0]),"function"==typeof t&&t(i,s),a=m(u[""].header,u[""].doctype)+i.documentElement.innerHTML+"</html>","function"==typeof r&&r(a),u={},f=!1},chrome.tabs.executeScript(e,{code:"("+y.toString()+")()",allFrames:!0,matchAboutBlank:!0},function(e){var t,r,n,l;for(r=0,n=e.length;r<n;r++)t=e[r],l={url:t[0],header:t[2],document:g(t[1],t[0]),framesIdx:t[4],doctype:t[5],actualUrls:t[6],styleSheets:t[7],text:t[1]},u[t[3]]=l;return h(o)})},e.exports=v},function(e,t){var r;r=function(e,t,r){var n,u;return e.indexOf("data:")>=0||e.length<10?r(null,t,e):(u=new XMLHttpRequest,u.open("GET",e,!0),u.responseType="blob",n=new FileReader,u.onload=function(u){var o;return 200!==this.status?r(null,t," ",e):(o=this.response,n.onloadend=function(){return r(null,t,n.result,e)},n.readAsDataURL(o))},u.onerror=function(n){return console.error("XHR Error "+n.target.status+" occurred while receiving the document."),r(n,t," ",e)},u.send())},e.exports=r},function(e,t){var r=[].indexOf||function(e){for(var t=0,r=this.length;t<r;t++)if(t in this&&this[t]===e)return t;return-1};e.exports=function(e,t,n){var u,o,l,i,s,c;if(u=!1,('"'===e[0]&&'"'===e[e.length-1]||"'"===e[0]&&"'"===e[e.length-1])&&(e=e.substr(1,e.length-2)),e.startsWith("data:"))return e;if(e=e.replace(/\s/g,""),t=t.split("#")[0],e.startsWith("//"))return n+e;if(e.match(/^[\w\-_\d]+:/))return e;if("/"===e[0]&&"/"!==e[1])return u=!0,c=t.split("/"),c=c.slice(0,3),t=c.join("/"),t+e;for(c=t.split("/"),r.call(c[c.length-1],".")>=0&&!u&&c.pop(),""===c[c.length-1]&&c.pop(),i=e.split("/"),o=0,s=i.length;o<s;o++)if(l=i[o],".."===l)c.pop();else{if("."===l)continue;c.push(l)}return c.join("/")}},function(e,t){e.exports=function(e){var t,r;try{return r=new XMLHttpRequest,r.open("GET",e,!1),r.send(),200===r.status?r.responseText:" "}catch(e){return t=e,console.error("XHR",t.stack)," "}}},function(e,t,r){var n,u,o,l,i;o=r(2),u=r(1),i=r(3),l=function(e,t){var r,n,u,o;for(r=0,n=u=0,o=e.length;0<=o?u<o:u>o;n=0<=o?++u:--u)t[e[n]]&&r++;return r},n=function(e,t,r){var n,u,l,i;for(u=/@font-face\s*\{[\s\S]*?src\s*:\s*(?:url\(\s*(['"])?([\s\S]*?)\1\s*\))+[\s\S]*?.*?\}/g,l=/url\(\s*(['"])?([\s\S]*?)\1\s*\)/g;null!=(n=u.exec(e));)for(;null!=(i=l.exec(n[0]));)t[o(i[2],r)]=!0;return t},e.exports=function(e,t,r,s,c,a){var f,h,d,m,p,g,b,v,y,A,x,S;if(m=!1,e.indexOf("@import")>-1&&(y=/@import\s+(?:url\((['"])?([\s\S]*?)\1\)|(['"])?([\s\S]*?)\3)\s*[^;]*?(?:;|$)/gim,e=e.replace(y,function(e){var t;return t=y.exec(e),null==t?"":null!=t[2]?i(o(t[2],r)):null!=t[4]?i(o(t[4],r)):void 0})),e.indexOf("url(")<0)return a(null,t,s,e,c);for(S=[],d=[],f=[],b=0,x=/([\s\S]*?url\()\s*(['"]?)([\s\S]*?)\2\s*(\))/gim,v=x.exec(e);null!=v;){if(d.push(v[1],v[4]),S.push(o(v[3],r)),b=x.lastIndex,!(e.indexOf("url(",b+1)>-1)){d.push(e.slice(b)),b=e.length;break}v=x.exec(e)}for(d.push(e.slice(b)),s.actualUrls=n(e,s.actualUrls,r),h=l(S,s.actualUrls),p=g=0,A=S.length;0<=A?g<A:g>A;p=0<=A?++g:--g)s.actualUrls[S[p]]&&(m=!0,s.actualUrls[S[p]],u(S[p],t,function(r,n,u,o){var l,i;if(h--,null!=r?console.error("Error base64:",r.stack):s.actualUrls[o]=u,0===h){for(e=[],l=0,i=0;l<d.length;)e.push(d[l]),l++,null!=S[i]&&(s.actualUrls[S[i]]||S[i].startsWith("data:")?S[i].startsWith("data:")?e.push('"'+S[i]+'"'):e.push('"'+s.actualUrls[S[i]]+'"'):e.push('""')),null!=d[l]&&e.push(d[l]),l++,i++;return a(null,t,s,e.join(""),c)}}));return m?void 0:a(null,t,s,d.join(""),c)}}])});
