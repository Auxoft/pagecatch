...
/*!
	   ...
	   */
return u={},f=!1,h=function(e){var t,r,n,o,c,h,d,m,p,g,b,v,y,E,T,w,L,B,N,O,H,C,M,q,U,j,I,_,R,W,D,P,X,G,J,F,Y,$,K,V,z,Q;for(M=null!=(j=u[""])?j.document.querySelectorAll("[name]"):void 0,p=0,y=M.length;p<y;p++)if(C=M[p],"original-url"===C.getAttribute("name"))return f=!0,void e(0,0,0);for(c=[],O=null!=(I=u[""])?I.document.querySelectorAll("link"):void 0,m=!1,d=0,g=0,E=O.length;g<E;g++)N=O[g],P=N.getAttribute("rel"),null!==P&&P.indexOf("icon")!==-1&&("icon"===P&&(m=!0),c.push(N));m||(z=null!=(_=u[""])?_.url[0]:void 0,Q=z.split("/"),Q=Q.slice(0,3),z=Q.join("/")+"/favicon.ico",N=document.createElement("link"),N.setAttribute("rel","icon"),d=1,S(z,N,function(t,n,o){var l;return null!=t?(d--,console.error("(src)Base 64 error:",t.stack)):(""===o?(d++,0!==c.length?l=c[0].getAttribute("href"):d--,e($,r,d),S(l,n,function(t,n,o){return null!=t?(d--,console.error("(src)Base 64 error:",t.stack)):(n.setAttribute("href",o),u[""].document.head.appendChild(n),d--),e($,r,d)})):(n.setAttribute("href",o),u[""].document.head.appendChild(n),d--),e($,r,d))})),r=0,$=0;for(b in u){for(o=u[b],o.document.head=a(o.document.head),F=o.document.querySelectorAll("style"),v=0,T=F.length;v<T;v++)if(J=F[v],0===J.innerHTML.length)for(X=s(J),R=o.styleSheets,H=0,w=R.length;H<w;H++)if(t=R[H],t[1]===X){J.innerHTML=t[0];break}for(V=o.document.querySelectorAll("*[style]"),q=0,L=V.length;q<L;q++)Y=V[q],r++,x(Y.getAttribute("style"),Y,o.url[0],o,[],function(t,n,u,o){return r--,null!=t?console.error("Style attr error",t):n.setAttribute("style",o),e($,r,d)});for(K=o.document.querySelectorAll("img,link,source,style, object"),U=0,B=K.length;U<B;U++)if(Y=K[U],$++,"LINK"!==Y.nodeName)if("IMG"!==Y.nodeName)if("OBJECT"!==Y.nodeName)if("STYLE"!==Y.nodeName)if("SOURCE"!==Y.nodeName)$--;else{if(Y.type.indexOf("video")>-1||Y.type.indexOf("audio")>-1){$--;continue}if(Y.hasAttribute("srcset")&&!Y.hasAttribute("src")){G=i(Y.getAttribute("srcset"),o.url[0],o.url[1]),S(G,Y,function(t,n,u){return $--,null!=t?console.error("(src)Base 64 error:",t.stack):n.setAttribute("srcset",u),e($,r,d)});continue}if(Y.hasAttribute("src")&&!Y.hasAttribute("srcset")){G=i(Y.getAttribute("src"),o.url[0],o.url[1]),S(G,Y,function(t,n,u){return $--,null!=t?console.error("(src)Base 64 error:",t.stack):n.setAttribute("src",u),e($,r,d)});continue}if(Y.hasAttribute("src")&&Y.hasAttribute("srcset")){Y.setAttribute("srcset",""),G=i(Y.getAttribute("src"),o.url[0],o.url[1]),S(G,Y,function(t,n,u){return $--,null!=t?console.error("(src)Base 64 error:",t.stack):n.setAttribute("src",u),e($,r,d)});continue}$--}else x(Y.innerHTML,Y,o.url[0],o,[],function(t,n,u,o){return $--,null!=t?console.error("(style)inlineCSS error:",t.stack):n.innerHTML=o,e($,r,d)});else{if(Y.hasAttribute("data")){G=i(Y.getAttribute("data"),o.url[0],o.url[1]),S(G,Y,function(t,n,u){return $--,null!=t?console.error("(src)Base 64 error:",t.stack):n.setAttribute("srcset",u),e($,r,d)});continue}$--}else{if(Y.hasAttribute("srcset")&&!Y.hasAttribute("src")){G=i(Y.getAttribute("srcset"),o.url[0],o.url[1]),S(G,Y,function(t,n,u){return $--,null!=t?console.error("(src)Base 64 error:",t.stack):n.setAttribute("srcset",u),e($,r,d)});continue}if(Y.hasAttribute("src")&&!Y.hasAttribute("srcset")){G=i(Y.getAttribute("src"),o.url[0],o.url[1]),S(G,Y,function(t,n,u){return $--,null!=t?console.error("(src)Base 64 error:",t.stack):n.setAttribute("src",u),e($,r,d)});continue}if(Y.hasAttribute("src")&&Y.hasAttribute("srcset")){Y.setAttribute("srcset",""),G=i(Y.getAttribute("src"),o.url[0],o.url[1]),S(G,Y,function(t,n,u){return $--,null!=t?console.error("(src)Base 64 error:",t.stack):n.setAttribute("src",u),e($,r,d)});continue}$--}else{if("stylesheet"===(W=Y.getAttribute("rel"))||"prefetch stylesheet"===W){h=i(Y.getAttribute("href"),o.url[0],o.url[1]),n=Y.attributes,x(A(h),Y,h,o,n,function(t,n,u,o,l){var i,s,c,a;if($--,null!=t)console.error("style error",t);else{for(console.log("INLINECSSS_END",n),J=document.createElement("style"),J.innerHTML=o,c=0,s=l.length;c<s;c++)i=l[c],J.setAttribute(i.name,i.value);a=n.parentElement,a.insertBefore(J,n),a.removeChild(n)}return e($,r,d)});continue}if(D=Y.getAttribute("rel"),k.call(l,D)>=0){Y.parentElement.removeChild(Y),$--;continue}h=i(Y.getAttribute("href"),o.url[0],o.url[1]),S(h,Y,function(t,n,u){return $--,null!=t?console.error("(href) xhrToBase64 error (href="+h+"):",t.stack):n.setAttribute("href",u),e($,r,d)})}}return f=!0,e($,r,d)},n=function(e,r){var o,l,i,s,a,f,h,d,p,g,v;for(s=e.document.getElementsByTagName("iframe"),p=[],f=0,d=s.length;f<d;f++){i=s[f],g=b(i,e.document),a=-1;for(h in e.framesIdx)g===h&&(a=e.framesIdx[h]);a!==-1&&(h=r+a,null!=u[h]?(n(u[h],h+":"),l=u[h].url,o=u[h].document,c(o,l),"function"==typeof t&&t(o,l),v=m(u[h].header,u[h].doctype)+o.documentElement.innerHTML+"</html>",p.push(i.setAttribute("srcdoc",v))):p.push(void 0))}return p},o=function(e,o,l){var i,s,a;if(console.log(e,o,l,f),0===e&&0===o&&0===l&&f===!0)return n(u[""],""),s=u[""].url,i=u[""].document,c(i,s),"function"==typeof t&&t(i,s),a=m(u[""].header,u[""].doctype)+i.documentElement.innerHTML+"</html>","function"==typeof r&&r(a),u={},f=!1},chrome.tabs.executeScript(e,{code:"("+y.toString()+")()",allFrames:!0,matchAboutBlank:!0},function(e){var t,r,n,l;for(r=0,n=e.length;r<n;r++)t=e[r],l={url:t[0],header:t[2],document:g(t[1],t[0]),framesIdx:t[4],doctype:t[5],actualUrls:t[6],styleSheets:t[7]},u[t[3]]=l;return h(o)})},e.exports=v},function(e,t){var r;r=function(e,t,r){var n,u;return e.indexOf("data:")>=0||e.length<10?r(null,t,e):(u=new XMLHttpRequest,u.open("GET",e,!0),u.responseType="blob",n=new FileReader,u.onload=function(u){var o;return 200!==this.status?r(null,t," ",e):(o=this.response,n.onloadend=function(){return r(null,t,n.result,e)},n.readAsDataURL(o))},u.onerror=function(n){return console.error("XHR Error "+n.target.status+" occurred while receiving the document."),r(n,t," ",e)},u.send())},e.exports=r},function(e,t){var r=[].indexOf||function(e){for(var t=0,r=this.length;t<r;t++)if(t in this&&this[t]===e)return t;return-1};e.exports=function(e,t,n){var u,o,l,i,s,c;if(u=!1,('"'===e[0]&&'"'===e[e.length-1]||"'"===e[0]&&"'"===e[e.length-1])&&(e=e.substr(1,e.length-2)),e.startsWith("data:"))return e;if(e=e.replace(/\s/g,""),t=t.split("#")[0],e.startsWith("//"))return n+e;if(e.match(/^[\w\-_\d]+:/))return e;if("/"===e[0]&&"/"!==e[1])return u=!0,c=t.split("/"),c=c.slice(0,3),t=c.join("/"),t+e;for(c=t.split("/"),r.call(c[c.length-1],".")>=0&&!u&&c.pop(),""===c[c.length-1]&&c.pop(),i=e.split("/"),o=0,s=i.length;o<s;o++)if(l=i[o],".."===l)c.pop();else{if("."===l)continue;c.push(l)}return c.join("/")}},function(e,t){e.exports=function(e){var t,r;try{return r=new XMLHttpRequest,r.open("GET",e,!1),r.send(),200===r.status?r.responseText:" "}catch(e){return t=e,console.error("XHR",t.stack)," "}}},function(e,t,r){var n,u,o,l,i;o=r(2),u=r(1),i=r(3),l=function(e,t){var r,n,u,o;for(r=0,n=u=0,o=e.length;0<=o?u<o:u>o;n=0<=o?++u:--u)t[e[n]]&&r++;return r},n=function(e,t,r){var n,u,l,i;for(u=/@font-face\s*\{[\s\S]*?src\s*:\s*(?:url\(\s*(['"])?([\s\S]*?)\1\s*\))+[\s\S]*?.*?\}/g,l=/url\(\s*(['"])?([\s\S]*?)\1\s*\)/g;null!=(n=u.exec(e));)for(;null!=(i=l.exec(n[0]));)t[o(i[2],r)]=!0;return t},e.exports=function(e,t,r,s,c,a){var f,h,d,m,p,g,b,v,y,A,x,S;if(m=!1,e.indexOf("@import")>-1&&(y=/@import\s+(?:url\((['"])?([\s\S]*?)\1\)|(['"])?([\s\S]*?)\3)\s*[^;]*?(?:;|$)/gim,e=e.replace(y,function(e){var t;return t=y.exec(e),null!=t[2]?i(o(t[2],r)):null!=t[4]?i(o(t[4],r)):void 0})),e.indexOf("url(")<0)return a(null,t,s,e,c);for(S=[],d=[],f=[],b=0,x=/([\s\S]*?url\()\s*(['"]?)([\s\S]*?)\2\s*(\))/gim,v=x.exec(e);null!=v;){if(d.push(v[1],v[4]),S.push(o(v[3],r)),b=x.lastIndex,!(e.indexOf("url(",b+1)>-1)){d.push(e.slice(b)),b=e.length;break}v=x.exec(e)}for(d.push(e.slice(b)),s.actualUrls=n(e,s.actualUrls,r),h=l(S,s.actualUrls),p=g=0,A=S.length;0<=A?g<A:g>A;p=0<=A?++g:--g)s.actualUrls[S[p]]&&(m=!0,s.actualUrls[S[p]],u(S[p],t,function(r,n,u,o){var l,i;if(h--,null!=r?console.error("Error base64:",r.stack):s.actualUrls[o]=u,0===h){for(e=[],l=0,i=0;l<d.length;)e.push(d[l]),l++,null!=S[i]&&(s.actualUrls[S[i]]||S[i].startsWith("data:")?S[i].startsWith("data:")?e.push('"'+S[i]+'"'):e.push('"'+s.actualUrls[S[i]]+'"'):e.push('""')),null!=d[l]&&e.push(d[l]),l++,i++;return a(null,t,s,e.join(""),c)}}));return m?void 0:a(null,t,s,d.join(""),c)}}])});
