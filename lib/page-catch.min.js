!function(e,t){"object"==typeof exports&&"object"==typeof module?module.exports=t():"function"==typeof define&&define.amd?define([],t):"object"==typeof exports?exports["page-catch"]=t():e["page-catch"]=t()}(this,function(){return function(e){function t(n){if(r[n])return r[n].exports;var o=r[n]={exports:{},id:n,loaded:!1};return e[n].call(o.exports,o,o.exports,t),o.loaded=!0,o.exports}var r={};return t.m=e,t.c=r,t.p="",t(0)}([function(e,t,r){var n,o,u,l,i,s,c,a,f,d,h,m,p,g,b,v,y,A,x,S,E,T,L=function(e,t){function r(){this.constructor=e}for(var n in t)k.call(t,n)&&(e[n]=t[n]);return r.prototype=t.prototype,e.prototype=new r,e.__super__=t.prototype,e},k={}.hasOwnProperty,w=[].indexOf||function(e){for(var t=0,r=this.length;t<r;t++)if(t in this&&this[t]===e)return t;return-1};T=r(1),i=r(2),S=r(3),E=r(4),l=["dns-prefetch","canonical","publisher","prefetch"," alternate","bb:rum"],n=["Content-Security-Policy","refresh"],o=function(e){function t(){return t.__super__.constructor.apply(this,arguments)}return L(t,e),t}(Error),x=function(){var e,t,r,n,o,u,l,i,s,c;/*!
...
return t=[],e=function(r){var n,o,u,l,i,s,c;if(s=r.parent,r!==s){for(u="?",c=s.frames,o=l=0,i=c.length;l<i;o=++l)if(n=c[o],r===n){u=o;break}t.unshift(u),e(s)}},e(window),t.join(":")},o=function(e){var t,r,n,o,u,l,i,s;for(t={},/*!
	     ...
	     * @example [3,0,0]
	     */
n=function(t){var r,n;return n=[],r=function(t){var o,u,l;if(t.parentElement!==e)return l=t.parentElement,u=Array.prototype.slice.call(l.children),o=u.indexOf(t),n.unshift(o),r(l)},r(t),JSON.stringify(n)},r=e.getElementsByTagName("iframe"),l=0,i=r.length;l<i;l++)for(u=r[l],o=0;o<window.frames.length;){if(u.contentWindow===window.frames[o]){t[n(u,e)]=o,s=[];break}o++}return t},n=function(e){return null!=e?[e.name,e.publicId,e.systemId]:null},t=function(e){var t,r,n,o;for(o=[],r=0,n=e.length;r<n;r++)t=e[r],o.push(t.nodeName,t.nodeValue);return o},[[document.URL,document.location.protocol],document.documentElement.outerHTML,t(document.documentElement.attributes),u(),o(document.documentElement),n(document.doctype),i,c]},h=function(e){var t,r,n,o;for(t=e.querySelectorAll("iframe"),r=n=0,o=t.length;0<=o?n<o:n>o;r=0<=o?++n:--n)t[r].parentElement.removeChild(t[r]),r--;return e},/*!
	 ...
	 */
v=function(e){var t,r,n,o,u,l,i,s,c,a,f,d,m,p,g;if(t=document.implementation.createHTMLDocument(),p=/(?:<!--[\s\S]*?-->|\s)*(<head[\s\S]*?>[\s\S]*?<\/head>)([\s\S]*)$/im,s=/<head(?:[\s\S]*?)>([\s\S]*?)<\/head>/,l=/<body(?:[\s\S]*?)>([\s\S]*?)<\/body>/,c=p.exec(e),i=c[1],u=c[2],g=document.createElement("html"),g.innerHTML=i+u,n=g.getElementsByTagName("body")[0].attributes,o=g.getElementsByTagName("head")[0].attributes,null!=c){for(t.head.innerHTML=s.exec(i)[1],t.head=h(t.head),t.body.innerHTML=l.exec(u)[1],a=0,d=n.length;a<d;a++)r=n[a],t.body.setAttribute(r.name,r.value);for(f=0,m=o.length;f<m;f++)r=o[f],t.head.setAttribute(r.name,r.value)}return t},/*!
...
/*!
	   ...
	   */
return o={},c=!1,a=function(e){var t,r,n,u,a,f,h,m,p,g,b,v,y,A,x,L,k,O,B,N,H,M,C,q,U,j,I,_,R,W,D,P,X,G,J,F,Y,$,K,V,z,Q;for(C=null!=(j=o[""])?j.document.querySelectorAll("[name]"):void 0,p=0,y=C.length;p<y;p++)if(M=C[p],"original-url"===M.getAttribute("name"))return c=!0,void e(0,0,0);for(a=[],N=null!=(I=o[""])?I.document.querySelectorAll("link"):void 0,m=!1,h=0,g=0,A=N.length;g<A;g++)B=N[g],P=B.getAttribute("rel"),null!==P&&P.indexOf("icon")!==-1&&("icon"===P&&(m=!0),a.push(B));m||(z=null!=(_=o[""])?_.url[0]:void 0,Q=z.split("/"),Q=Q.slice(0,3),z=Q.join("/")+"/favicon.ico",B=document.createElement("link"),B.setAttribute("rel","icon"),h=1,T(z,B,function(t,n,u){var l;return null!=t?(h--,console.error("(src)Base 64 error:",t.stack)):(""===u?(h++,0!==a.length?l=a[0].getAttribute("href"):h--,e($,r,h),T(l,n,function(t,n,u){return null!=t?(h--,console.error("(src)Base 64 error:",t.stack)):(n.setAttribute("href",u),o[""].document.head.appendChild(n),h--),e($,r,h)})):(n.setAttribute("href",u),o[""].document.head.appendChild(n),h--),e($,r,h))})),r=0,$=0;for(b in o){for(u=o[b],u.document.head=d(u.document.head),F=u.document.querySelectorAll("style"),v=0,x=F.length;v<x;v++)if(J=F[v],0===J.innerHTML.length)for(X=s(J),R=u.styleSheets,H=0,L=R.length;H<L;H++)if(t=R[H],t[1]===X){J.innerHTML=t[0];break}for(V=u.document.querySelectorAll("*[style]"),q=0,k=V.length;q<k;q++)Y=V[q],r++,E(Y.getAttribute("style"),Y,u.url[0],u,[],function(t,n,o,u){return r--,null!=t?console.error("Style attr error",t):n.setAttribute("style",u),e($,r,h)});for(K=u.document.querySelectorAll("img,link,source,style, object"),U=0,O=K.length;U<O;U++)if(Y=K[U],$++,"LINK"!==Y.nodeName)if("IMG"!==Y.nodeName)if("OBJECT"!==Y.nodeName)if("STYLE"!==Y.nodeName)if("SOURCE"!==Y.nodeName)$--;else{if(Y.type.indexOf("video")>-1||Y.type.indexOf("audio")>-1){$--;continue}if(Y.hasAttribute("srcset")&&!Y.hasAttribute("src")){G=i(Y.getAttribute("srcset"),u.url[0],u.url[1]),T(G,Y,function(t,n,o){return $--,null!=t?console.error("(src)Base 64 error:",t.stack):n.setAttribute("srcset",o),e($,r,h)});continue}if(Y.hasAttribute("src")&&!Y.hasAttribute("srcset")){G=i(Y.getAttribute("src"),u.url[0],u.url[1]),T(G,Y,function(t,n,o){return $--,null!=t?console.error("(src)Base 64 error:",t.stack):n.setAttribute("src",o),e($,r,h)});continue}if(Y.hasAttribute("src")&&Y.hasAttribute("srcset")){Y.setAttribute("srcset",""),G=i(Y.getAttribute("src"),u.url[0],u.url[1]),T(G,Y,function(t,n,o){return $--,null!=t?console.error("(src)Base 64 error:",t.stack):n.setAttribute("src",o),e($,r,h)});continue}$--}else E(Y.innerHTML,Y,u.url[0],u,[],function(t,n,o,u){return $--,null!=t?console.error("(style)inlineCSS error:",t.stack):n.innerHTML=u,e($,r,h)});else{if(Y.hasAttribute("data")){G=i(Y.getAttribute("data"),u.url[0],u.url[1]),T(G,Y,function(t,n,o){return $--,null!=t?console.error("(src)Base 64 error:",t.stack):n.setAttribute("srcset",o),e($,r,h)});continue}$--}else{if(Y.hasAttribute("srcset")&&!Y.hasAttribute("src")){G=i(Y.getAttribute("srcset"),u.url[0],u.url[1]),T(G,Y,function(t,n,o){return $--,null!=t?console.error("(src)Base 64 error:",t.stack):n.setAttribute("srcset",o),e($,r,h)});continue}if(Y.hasAttribute("src")&&!Y.hasAttribute("srcset")){G=i(Y.getAttribute("src"),u.url[0],u.url[1]),T(G,Y,function(t,n,o){return $--,null!=t?console.error("(src)Base 64 error:",t.stack):n.setAttribute("src",o),e($,r,h)});continue}if(Y.hasAttribute("src")&&Y.hasAttribute("srcset")){Y.setAttribute("srcset",""),G=i(Y.getAttribute("src"),u.url[0],u.url[1]),T(G,Y,function(t,n,o){return $--,null!=t?console.error("(src)Base 64 error:",t.stack):n.setAttribute("src",o),e($,r,h)});continue}$--}else{if("stylesheet"===(W=Y.getAttribute("rel"))||"prefetch stylesheet"===W){f=i(Y.getAttribute("href"),u.url[0],u.url[1]),n=Y.attributes,E(S(f),Y,f,u,n,function(t,n,o,u,l){var i,s,c,a;if($--,null!=t)console.error("style error",t);else{for(console.log("INLINECSSS_END",n),J=document.createElement("style"),J.innerHTML=u,c=0,s=l.length;c<s;c++)i=l[c],J.setAttribute(i.name,i.value);a=n.parentElement,a.insertBefore(J,n),a.removeChild(n)}return e($,r,h)});continue}if(D=Y.getAttribute("rel"),w.call(l,D)>=0){Y.parentElement.removeChild(Y),$--;continue}f=i(Y.getAttribute("href"),u.url[0],u.url[1]),T(f,Y,function(t,n,o){return $--,null!=t?console.error("(href) xhrToBase64 error (href="+f+"):",t.stack):n.setAttribute("href",o),e($,r,h)})}}return c=!0,e($,r,h)},n=function(e,r){var u,l,i,s,c,a,d,h,m,p,b;for(s=e.document.getElementsByTagName("iframe"),m=[],a=0,h=s.length;a<h;a++){i=s[a],p=y(i,e.document),c=-1;for(d in e.framesIdx)p===d&&(c=e.framesIdx[d]);c!==-1&&(d=r+c,null!=o[d]?(n(o[d],d+":"),l=o[d].url,u=o[d].document,f(u,l[0]),"function"==typeof t&&t(u,l[0]),b=g(o[d].header,o[d].doctype)+u.documentElement.innerHTML+"</html>",m.push(i.setAttribute("srcdoc",b))):m.push(void 0))}return m},h=function(){var e,t;if(e=document.querySelector('meta[name="original-url"]'),t=e.content.split("#"),t[1])return window.location.hash=t[1]},u=function(e,u,l){var i,s,a,d;if(console.log(e,u,l,c),0===e&&0===u&&0===l&&c===!0)return n(o[""],""),s=o[""].url,i=o[""].document,f(i,s[0]),"function"==typeof t&&t(i,s),d=document.createElement("script"),d.innerHTML="("+h.toString()+")()",i.body.appendChild(d),a=g(o[""].header,o[""].doctype)+i.documentElement.innerHTML+"</html>","function"==typeof r&&r(a),o={},c=!1},chrome.tabs.executeScript(e,{code:"("+x.toString()+")()",allFrames:!0,matchAboutBlank:!0},function(e){var t,r,n,l;for(r=0,n=e.length;r<n;r++)t=e[r],l={url:t[0],header:t[2],document:v(t[1]),framesIdx:t[4],doctype:t[5],actualUrls:t[6],styleSheets:t[7]},o[t[3]]=l;return a(u)})},e.exports=A},function(e,t){var r;r=function(e,t,r){var n,o;return e.indexOf("data:")>=0||e.length<10?r(null,t,e):(o=new XMLHttpRequest,o.open("GET",e,!0),o.responseType="blob",n=new FileReader,o.onload=function(o){var u;return 200!==this.status?r(null,t," ",e):(u=this.response,n.onloadend=function(){return r(null,t,n.result,e)},n.readAsDataURL(u))},o.onerror=function(n){return console.error("XHR Error "+n.target.status+" occurred while receiving the document."),r(n,t," ",e)},o.send())},e.exports=r},function(e,t){var r=[].indexOf||function(e){for(var t=0,r=this.length;t<r;t++)if(t in this&&this[t]===e)return t;return-1};e.exports=function(e,t,n){var o,u,l,i,s,c;if(o=!1,('"'===e[0]&&'"'===e[e.length-1]||"'"===e[0]&&"'"===e[e.length-1])&&(e=e.substr(1,e.length-2)),e.startsWith("data:"))return e;if(e=e.replace(/\s/g,""),t=t.split("#")[0],e.startsWith("//"))return n+e;if(e.match(/^[\w\-_\d]+:/))return e;if("/"===e[0]&&"/"!==e[1])return o=!0,c=t.split("/"),c=c.slice(0,3),t=c.join("/"),t+e;for(c=t.split("/"),r.call(c[c.length-1],".")>=0&&!o&&c.pop(),""===c[c.length-1]&&c.pop(),i=e.split("/"),u=0,s=i.length;u<s;u++)if(l=i[u],".."===l)c.pop();else{if("."===l)continue;c.push(l)}return c.join("/")}},function(e,t){e.exports=function(e){var t,r;try{return r=new XMLHttpRequest,r.open("GET",e,!1),r.send(),200===r.status?r.responseText:" "}catch(e){return t=e,console.error("XHR",t.stack)," "}}},function(e,t,r){var n,o,u,l,i;u=r(2),o=r(1),i=r(3),l=function(e,t){var r,n,o,u;for(r=0,n=o=0,u=e.length;0<=u?o<u:o>u;n=0<=u?++o:--o)t[e[n]]&&r++;return r},n=function(e,t,r){var n,o,l,i;for(o=/@font-face\s*\{[\s\S]*?src\s*:\s*(?:url\(\s*(['"])?([\s\S]*?)\1\s*\))+[\s\S]*?.*?\}/g,l=/url\(\s*(['"])?([\s\S]*?)\1\s*\)/g;null!=(n=o.exec(e));)for(;null!=(i=l.exec(n[0]));)t[u(i[2],r)]=!0;return t},e.exports=function(e,t,r,s,c,a){var f,d,h,m,p,g,b,v,y,A,x,S;if(m=!1,e.indexOf("@import")>-1&&(y=/@import\s+(?:url\((['"])?([\s\S]*?)\1\)|(['"])?([\s\S]*?)\3)\s*[^;]*?(?:;|$)/gim,e=e.replace(y,function(e){var t;return t=y.exec(e),null==t?"":null!=t[2]?i(u(t[2],r)):null!=t[4]?i(u(t[4],r)):void 0})),e.indexOf("url(")<0)return a(null,t,s,e,c);for(S=[],h=[],f=[],b=0,x=/([\s\S]*?url\()\s*(['"]?)([\s\S]*?)\2\s*(\))/gim,v=x.exec(e);null!=v;){if(h.push(v[1],v[4]),S.push(u(v[3],r,new URL(r).protocol)),b=x.lastIndex,!(e.indexOf("url(",b+1)>-1)){h.push(e.slice(b)),b=e.length;break}v=x.exec(e)}for(h.push(e.slice(b)),s.actualUrls=n(e,s.actualUrls,r),d=l(S,s.actualUrls),p=g=0,A=S.length;0<=A?g<A:g>A;p=0<=A?++g:--g)s.actualUrls[S[p]]&&(m=!0,s.actualUrls[S[p]],o(S[p],t,function(r,n,o,u){var l,i;if(d--,null!=r?console.error("Error base64:",r.stack):s.actualUrls[u]=o,0===d){for(e=[],l=0,i=0;l<h.length;)e.push(h[l]),l++,null!=S[i]&&(s.actualUrls[S[i]]||S[i].startsWith("data:")?S[i].startsWith("data:")?e.push('"'+S[i]+'"'):e.push('"'+s.actualUrls[S[i]]+'"'):e.push('""')),null!=h[l]&&e.push(h[l]),l++,i++;return a(null,t,s,e.join(""),c)}}));return m?void 0:a(null,t,s,h.join(""),c)}}])});
