!function(e,t){"object"==typeof exports&&"object"==typeof module?module.exports=t():"function"==typeof define&&define.amd?define([],t):"object"==typeof exports?exports["page-catch"]=t():e["page-catch"]=t()}(this,function(){return function(e){function t(n){if(r[n])return r[n].exports;var o=r[n]={exports:{},id:n,loaded:!1};return e[n].call(o.exports,o,o.exports,t),o.loaded=!0,o.exports}var r={};return t.m=e,t.c=r,t.p="",t(0)}([function(e,t,r){var n,o,u,i,l,a,c,s,f,d,h,m,p,g,y,b,v=function(e,t){function r(){this.constructor=e}for(var n in t)x.call(t,n)&&(e[n]=t[n]);return r.prototype=t.prototype,e.prototype=new r,e.__super__=t.prototype,e},x={}.hasOwnProperty,E=[].indexOf||function(e){for(var t=0,r=this.length;t<r;t++)if(t in this&&this[t]===e)return t;return-1};b=r(1),i=r(2),g=r(3),y=r(4),n=["Content-Security-Policy","refresh"],o=function(e){function t(){return t.__super__.constructor.apply(this,arguments)}return v(t,e),t}(Error),p=function(){/*!
...
return n=function(){var e,t;/*!
	     ...
	     */
return t=[],e=function(r){var n,o,u,i,l,a,c;if(a=r.parent,r!==a){for(u="?",c=a.frames,o=i=0,l=c.length;i<l;o=++i)if(n=c[o],r===n){u=o;break}t.unshift(u),e(a)}},e(window),t.join(":")},r=function(e){var t,r,n,o,u,i,l,a;for(t={},/*!
	     * get frameID
	     * @param {HTMLIframeElement} obj - iframe document object
	     * @return {String} - string with index iframe
	     * @example [3,0,0]
	     */
n=function(t){var r,n;return n=[],r=function(t){var o,u,i;if(t.parentElement!==e)return i=t.parentElement,u=Array.prototype.slice.call(i.children),o=u.indexOf(t),n.unshift(o),r(i)},r(t),JSON.stringify(n)},r=e.getElementsByTagName("iframe"),i=0,l=r.length;i<l;i++)for(u=r[i],o=0;o<window.frames.length;){if(u.contentWindow===window.frames[o]){t[n(u,e)]=o,a=[];break}o++}return t},t=function(e){return null!=e?[e.name,e.publicId,e.systemId]:null},e=function(e){var t,r,n,o;for(o=[],r=0,n=e.length;r<n;r++)t=e[r],o.push(t.nodeName,t.nodeValue);return o},[document.URL,document.documentElement.innerHTML,e(document.documentElement.attributes),n(),r(document.documentElement),t(document.doctype)]},/*!
	 ...
	 */
d=function(e){var t,r,n,o,u,i,l;for(t=document.createElement("html"),u=document.createElement("html"),u.innerHTML=e.substring(e.indexOf("<body"),e.length),n=u.getElementsByTagName("body")[0].attributes,t.innerHTML="<head></head><body></body>",t.getElementsByTagName("head")[0].innerHTML=e.substring(e.indexOf("<head"),e.indexOf("/head>")+6),t.getElementsByTagName("body")[0].innerHTML=e.substring(e.indexOf("<body"),e.length),o=t.getElementsByTagName("body")[0],i=0,l=n.length;i<l;i++)r=n[i],o.setAttribute(r.name,r.value);return t},/*!
	 ...
	 * @example [3,0,0]
	 */
h=function(e,t){var r,n;return n=[],r=function(e){var o,u,i;if(e.parentElement!==t)return i=e.parentElement,u=Array.prototype.slice.call(i.children),o=u.indexOf(e),n.unshift(o),r(i)},r(e),JSON.stringify(n)},/*!
...
u=function(e,t){var r,n,o;return n=document.createElement("meta"),n.setAttribute("name","original-url"),n.setAttribute("content",t),r=null!=(o=e.getElementsByTagName("head")[0])?o:e.getElementsByTagName("body")[0],r.insertBefore(n,r.children[0])},/*!
	 ...
	 * @param {String} - string with url of current iframe
	 */
l=function(e,t){return a(e),c(e),u(e,t)},/*!
	 ...
	 */
s=function(e,t){var r,n,o,u,i;for(i="<html ",n=o=0,u=e.length;o<u&&null!=e[n+1];n=o+=2)i+=e[n]+'="'+e[n+1]+'" ';return null!=t?(r=f(t),r+i+">"):i+=">"},/*!
...
/*!
	   ...
	   */
return o={},a=!1,c=function(e){var t,r,n,u,l,c,s,f,d,h,m,p,v,x,E,A,T,O;for(p=null!=(v=o[""])?v.document.querySelectorAll("[name]"):void 0,u=0,f=p.length;u<f;u++)if(m=p[u],"original-url"===m.getAttribute("name"))return a=!0,void e(0,0);t=0,A=0;for(c in o){for(r=o[c],O=r.document.querySelectorAll("*[style]"),l=0,d=O.length;l<d;l++)E=O[l],t++,y(E.getAttribute("style"),E,r.url,function(r,n,o){return t--,null!=r?console.error("Style attr error",r):n.setAttribute("style",o),e(A,t)});for(T=r.document.querySelectorAll("img,link,style"),s=0,h=T.length;s<h;s++)E=T[s],A++,E.hasAttribute("src")?(x=i(E.getAttribute("src"),r.url),b(x,E,function(r,n,o){return A--,null!=r?console.error("(src)Base 64 error:",r.stack):n.setAttribute("src",o),e(A,t)})):E.hasAttribute("href")?"stylesheet"===E.getAttribute("rel")?(n=i(E.getAttribute("href"),r.url),y(g(n),E,n,function(r,n,o){var u,i;return null!=r?console.error("style error",r):(A--,i=document.createElement("style"),i.innerHTML=o,u=n.parentElement,n.parentElement.insertBefore(i,n),n.parentElement.removeChild(n)),e(A,t)})):(n=i(E.getAttribute("href"),r.url),b(n,E,function(r,o,u){return A--,null!=r?console.error("(href) xhrToBase64 error (href="+n+"):",r.stack):o.setAttribute("href",u),e(A,t)})):y(E.innerHTML,E,r.url,function(r,n,o){return A--,null!=r?(console.error("(style)inlineCSS error:",r.stack),console.error(n.innerHTML)):n.innerHTML=o,e(A,t)})}return a=!0},n=function(e,r){var u,i,a,c,f,d,m,p,g,y,b;for(c=e.document.getElementsByTagName("iframe"),g=[],d=0,p=c.length;d<p;d++){a=c[d],y=h(a,e.document),f=-1;for(m in e.framesIdx)y===m&&(f=e.framesIdx[m]);f!==-1&&(m=r+f,null!=o[m]?(n(o[m],m+":"),i=o[m].url,u=o[m].document,l(u,i),"function"==typeof t&&t(u,i),b=s(o[m].header,o[m].doctype)+u.innerHTML+"</html>",g.push(a.setAttribute("srcdoc",b))):g.push(void 0))}return g},u=function(e,u){var i,c,f;if(0===e&&0===u&&a===!0)return n(o[""],""),c=o[""].url,i=o[""].document,l(i,c),"function"==typeof t&&t(i,c),f=s(o[""].header,o[""].doctype)+i.innerHTML+"</html>","function"==typeof r&&r(f),o={},a=!1},chrome.tabs.executeScript(e,{code:"("+p.toString()+")()",allFrames:!0,matchAboutBlank:!0},function(e){var t,r,n,i;for(r=0,n=e.length;r<n;r++)t=e[r],i={url:t[0],header:t[2],document:d(t[1]),framesIdx:t[4],doctype:t[5]},o[t[3]]=i;return c(u)})},e.exports=m},function(e,t){var r;r=function(e,t,r){var n,o;return e.indexOf("data:")>=0?r(null,t,e):(o=new XMLHttpRequest,o.open("GET",e,!0),o.responseType="blob",n=new FileReader,o.onload=function(o){var u;return 200!==this.status?r(null,t," ",e):(u=this.response,n.onloadend=function(){return r(null,t,n.result,e)},n.readAsDataURL(u))},o.onerror=function(n){return console.error("XHR Error "+n.target.status+" occurred while receiving the document."),r(n,t,e,e)},o.send())},e.exports=r},function(e,t){var r,n,o;n=function(e,t,r){var n,o;if(r===!0)return o=document.createElement("a"),o.href=e,o.protocol+"//"+o.hostname;for(n=e.length;"/"!==e[n];)n--;for(e=e.substr(0,n),n=e.length;0!==t;)"/"===e[n]&&t--,n--;return e=e.substr(0,n+1)},o=function(e){var t,r;for(r=0,t=0;e.indexOf("..",r)!==-1&&e.indexOf("./",r)!==-1;)e.indexOf("..",r)===-1?r=e.indexOf("./",r)+2:(t++,r=e.indexOf("..",r)+3);return 0===t&&"/"===e[0]?(e=e.substr(1),[e,t,!0]):(0!==r&&(e=e.substr(r)),[e,t,!1])},r=function(e){var t,r;for(t=e.length-1,r="";"/"!==e[t];)r=e[t]+r,t--;return r},e.exports=function(e,t){var r;return e=e.replace(/\s/g,""),('"'===e[0]&&'"'===e[e.length-1]||"'"===e[0]&&"'"===e[e.length-1])&&(e=e.substr(1,e.length-2)),"/"===e[0]&&"/"===e[1]?"https:"+e:e.match(/^[\w\-_\d]+:/)?e:(r=o(e),e=r[0],r[2]===!0?n(t,r[1],r[2])+"/"+e:n(t,r[1],r[2])+"/"+e)}},function(e,t){e.exports=function(e){var t,r;try{return r=new XMLHttpRequest,r.open("GET",e,!1),r.send(),200===r.status?r.responseText:" "}catch(e){return t=e,console.error("XHR",t.stack)," "}}},function(e,t,r){var n,o;o=r(2),n=r(1),e.exports=function(e,t,r,u){var i,l,a,c,s,f,d,h,m,p;if(e.indexOf("url(")<0)return u(null,t,e);for(p=[],a=[],i=[],c=0;c<e.length;){if(f=e.indexOf("url(",c),f===-1){a.push(e.substring(c,e.length));break}a.push(e.substring(c,f+4)),s=e.indexOf(")",f+1),p.push(o(e.substring(f+4,s),r)),c=s}for(l=p.length,m=[],c=d=0,h=p.length;0<=h?d<h:d>h;c=0<=h?++d:--d)m.push(n(p[c],t,function(r,n,o,f){var d,h,m,g,y,b,v;if(l--,null!=r?console.error("Error base64:",r.stack):i.push([f,o]),0===l){for(e="",c=0,b=0,g=a.length;b<g;b++)if(h=a[b],e+=h,null!=p[c]){for(s=-1,m=v=0,y=i.length;v<y;m=++v)if(d=i[m],d[0]===p[c]){s=m;break}s>=0&&(e+=i[s][1]),c++}return u(null,t,e)}}));return m}}])});
