!function(e,t){"object"==typeof exports&&"object"==typeof module?module.exports=t():"function"==typeof define&&define.amd?define([],t):"object"==typeof exports?exports["page-catch"]=t():e["page-catch"]=t()}(this,function(){return function(e){function t(n){if(r[n])return r[n].exports;var o=r[n]={exports:{},id:n,loaded:!1};return e[n].call(o.exports,o,o.exports,t),o.loaded=!0,o.exports}var r={};return t.m=e,t.c=r,t.p="",t(0)}([function(e,t,r){var n,o,u,l,i,s,c,a,f,d,h,m,p,g,b,v,y,A,x,E,S,T,w=function(e,t){function r(){this.constructor=e}for(var n in t)k.call(t,n)&&(e[n]=t[n]);return r.prototype=t.prototype,e.prototype=new r,e.__super__=t.prototype,e},k={}.hasOwnProperty,L=[].indexOf||function(e){for(var t=0,r=this.length;t<r;t++)if(t in this&&this[t]===e)return t;return-1};T=r(1),i=r(2),E=r(3),S=r(4),l=["dns-prefetch","canonical","publisher","prefetch"," alternate","bb:rum"],n=["Content-Security-Policy","refresh"],o=function(e){function t(){return t.__super__.constructor.apply(this,arguments)}return w(t,e),t}(Error),x=function(){var e,t,r,n,o,u,l,i,s,c,a,f,d,h;/*!
...
/*!
	   ...
	   */
return i={},h=[],e=function(e){var t,r,n,o,u,l,i;for(i=[];e&&"HTML"!==e.nodeName;){if(u=e.parentElement)for(l=u.children,r=n=0,o=l.length;n<o;r=++n)if(t=l[r],u.children[r]===e){i.unshift(r);break}e=u}return i=i.join(":")},r=function(t){var r,n,o,u,l;for(n=0,o=t.length;n<o;n++){l=t[n],u="";try{null!=l.rules&&(u=Array.from(l.rules).map(function(e){return e.cssText}).join("\n"),h.push([u,e(l.ownerNode)]))}catch(e){r=e}}},r(document.styleSheets),l=function(e){var t,r,n,o,u,l,s;for(l=[],n=0,u=e.length;n<u;n++)t=e[n],s=e[t].indexOf("url("),l.push(function(){var n;for(n=[];s>-1;)r=e[t].indexOf(")",s+1),o=e[t].substring(s+4,r),(o.startsWith('"')||o.startsWith("'"))&&(o=o.substring(1,o.length-1)),o.startsWith("#")||(i[o]=!0),n.push(s=e[t].indexOf("url(",r+1));return n}());return l},s=function(e){var t,r,n,o;if(null!=e){for(o=e.children,r=0,n=o.length;r<n;r++)t=o[r],s(t);return l(window.getComputedStyle(e)),l(window.getComputedStyle(e,":after")),l(window.getComputedStyle(e,":before"))}},s(document.body),u=function(){var e,t;/*!
...
return t=[],e=function(r){var n,o,u,l,i,s,c;if(s=r.parent,r!==s){for(u="?",c=s.frames,o=l=0,i=c.length;l<i;o=++l)if(n=c[o],r===n){u=o;break}t.unshift(u),e(s)}},e(window),t.join(":")},o=function(e){var t,r,n,o,u,l,i,s;for(t={},/*!
	     ...
	     * @example [3,0,0]
	     */
n=function(t){var r,n;return n=[],r=function(t){var o,u,l;if(t.parentElement!==e)return l=t.parentElement,u=Array.prototype.slice.call(l.children),o=u.indexOf(t),n.unshift(o),r(l)},r(t),JSON.stringify(n)},r=e.getElementsByTagName("iframe"),l=0,i=r.length;l<i;l++)for(u=r[l],o=0;o<window.frames.length;){if(u.contentWindow===window.frames[o]){t[n(u,e)]=o,s=[];break}o++}return t},n=function(e){return null!=e?[e.name,e.publicId,e.systemId]:null},t=function(e){var t,r,n,o;for(o=[],r=0,n=e.length;r<n;r++)t=e[r],o.push(t.nodeName,t.nodeValue);return o},[[document.URL,document.location.protocol],[null!=(c=null!=(a=document.head)?a.innerHTML:void 0)?c:"",null!=(f=null!=(d=document.body)?d.outerHTML:void 0)?f:""],t(document.documentElement.attributes),u(),o(document.documentElement),n(document.doctype),i,h]},h=function(e){var t,r,n,o;for(t=e.querySelectorAll("iframe"),r=n=0,o=t.length;0<=o?n<o:n>o;r=0<=o?++n:--n)t[r].parentElement.removeChild(t[r]),r--;return e},/*!
	 ...
	 */
v=function(e,t){var r;return r=document.implementation.createHTMLDocument(),r.head.innerHTML=e,r.head=h(r.head),r.body.outerHTML=t,r.getElementsByTagName("head")[1].parentElement.removeChild(r.getElementsByTagName("head")[1]),r},/*!
...
y=function(e,t){var r,n;return n=[],r=function(e){var o,u,l;if(e.parentElement!==t.documentElement)return l=e.parentElement,u=Array.prototype.slice.call(l.children),o=u.indexOf(e),n.unshift(o),r(l)},r(e),JSON.stringify(n)},/*!
	 ...
	 */
m=function(e){var t;return t=e.querySelectorAll("meta[http-equiv]"),t.forEach(function(e){var t,r;if(t=e.getAttribute("http-equiv"),L.call(n,t)>=0)return null!=(r=e.parentElement)?r.removeChild(e):void 0})},/*!
	 * delete iframe security policy
	 * @param {HTMLDocument} - DOM object
	 */
